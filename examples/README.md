...
Notes:
- The Java example assumes JNA is available on the classpath.
...
- The C API uses flat `double*` buffers, so the C# and VBA examples show how to flatten 2D matrices into row-major 1D arrays before calling native functions.
